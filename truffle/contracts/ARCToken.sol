...
contract arcToken is StandardToken, SafeMath {
    ...
    uint public etherCap = 50000000 * 10**18; //max amount raised during crowdsale (50m Ether is approximately 550M USD)
    ...
    uint public bountyAllocation = 25000000 * 10**18; //25M tokens allocated post-crowdsale for the bounty fund
